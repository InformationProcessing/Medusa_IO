...
(
    ...
    localparam PAD20 = log2ceil(64'h1001208 - 64'h1001200); 
    localparam PAD21 = log2ceil(64'h1001210 - 64'h1001208); 
    localparam PAD22 = log2ceil(64'h1001212 - 64'h1001210); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1001212;
    ...
    // ( 0x1001190 .. 0x10011a0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 25'h1001190   ) begin
    ...
    // ( 0x1001200 .. 0x1001208 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 25'h1001200  && read_transaction  ) begin
            src_channel = 23'b00000000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x1001208 .. 0x1001210 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 25'h1001208   ) begin
            src_channel = 23'b00000000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x1001210 .. 0x1001212 )
    if ( {address[RG:PAD22],{PAD22{1'b0}}} == 25'h1001210   ) begin
