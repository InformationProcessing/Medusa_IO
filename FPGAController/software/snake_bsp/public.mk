...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../snake.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001270
SOPC_SYSID_FLAG += --sidp=0x1001270
ELF_PATCH_FLAG  += --sidp 0x1001270

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1647714880
SOPC_SYSID_FLAG += --timestamp=1647714880
ELF_PATCH_FLAG  += --timestamp 1647714880
